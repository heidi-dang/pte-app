...
| Correct branch (feat/phase-a-product-contract) | 2 | Branch name matches specification |
...
| Complete role definition | 4 | All eight user roles defined with permissions |
| Complete routes | 4 | All planned routes documented with roles, purpose, loading, empty, error and mobile states |
...
### PTE Coverage — 15 points

| Criterion | Points | Evidence Required |
|-----------|--------|-------------------|
| All current task types documented | 10 | All 22 task types present in task blueprints |
| No missing interaction | 3 | Practice-mode and mock-mode differences documented per task |
| Practice and mock differences documented | 2 | Clear separation of behaviour between modes |
...
| Calibration | 3 | Calibration process defined with metrics |
...
| Offline handling | 2 | Internet interruption behaviour documented |
...
| Recovery paths | 2 | Recovery from interruption, expiry and failure documented |

### Testing and Release Gates — 10 points

| Criterion | Points | Evidence Required |
|-----------|--------|-------------------|
| Test layers | 3 | Unit, integration, E2E and stability tests defined |
| Browser matrix | 2 | Browser compatibility matrix documented |
| Stability tests | 2 | Recovery and failure tests documented |
| Acceptance criteria | 3 | Measurable criteria for all major features |
...
| Consistent | 1 | Terminology, formatting and style are consistent |
| No placeholders | 1 | No TODO, TBD, FIXME, INSERT HERE or COMING SOON |
| No contradictions | 1 | No conflicting requirements or policies |
