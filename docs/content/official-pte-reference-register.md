# Official PTE Reference Register

## Purpose

This register documents the official Pearson sources used to derive task format, timing, scoring and behavioural requirements for the platform. Every task blueprint and behavioural specification must cite the relevant sources from this register.

## Sources

### Source 1: PTE Academic Test Format Overview

| Field | Value |
|-------|-------|
| Source title | PTE Academic test format |
| Publisher | Pearson PTE |
...
| Field | Value |
|-------|-------|
| Source title | PTE Academic Speaking and Writing format |
| Publisher | Pearson PTE |
...
| Field | Value |
|-------|-------|
| Source title | PTE Academic Reading format |
| Publisher | Pearson PTE |
...
| Field | Value |
|-------|-------|
| Source title | PTE Academic Listening format |
| Publisher | Pearson PTE |
...
| Field | Value |
|-------|-------|
| Source title | PTE Academic Test Taker Score Guide |
| Publisher | Pearson PTE |
